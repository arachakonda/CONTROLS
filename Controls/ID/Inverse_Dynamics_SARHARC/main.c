...
void read_traj(void){
    ...
    FILE* fp_q_ref = fopen("../myproject/SARHARC/q_ref.csv", "r");
...
/*            printf("\n");*/
    ...
    FILE* fp_qd_ref = fopen("../myproject/SARHARC/qd_ref.csv", "r");
...
/*            printf("\n");*/
    ...
    FILE* fp_qdd_ref = fopen("../myproject/SARHARC/qdd_ref.csv", "r");
